...
// const redis = new Redis("redis://default:AcIuAAIjcDEyY2E3NmMzNTVkMjM0YjNlOWNmN2UyMDU5ZDE4MDU3MnAxMA@refined-meerkat-49710.upstash.io:6379");
...
const redis = new Redis({
    host: "refined-meerkat-49710.upstash.io",
    port: 6379,
    password: "AcIuAAIjcDEyY2E3NmMzNTVkMjM0YjNlOWNmN2UyMDU5ZDE4MDU3MnAxMA",
    username: "default",
    maxRetriesPerRequest: 10, // Kam retries
    retryStrategy: (times) => {
        return Math.min(times * 500, 3000); // Exponential backoff, max 3 seconds wait
    },
